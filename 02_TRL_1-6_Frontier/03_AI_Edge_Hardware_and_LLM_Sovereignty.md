...
| :--- | :--- | :--- | :--- | :--- |
| **ISA Architecture** | Проприетарная CUDA PTX / SASS | **[RISC-V](../lib-1/RISC-V.md)** (RVV 1.0 + Custom `Xmatrix`) | **TRL 5–6** | Фрагментация нестандартных расширений ISA |
| **Kernel DSL Layer** | CUDA C/C++ / PTX Assembly | **[Triton Compiler](../lib-1/Triton%20Compiler.md)** / Halide | **TRL 5** | Неполное покрытие нелинейных слоев |
| **Compiler Pipeline** | NVCC / NVVM (Closed Source) | **[MLIR Framework](../lib-1/MLIR%20Framework.md)** + LLVM Target Passes | **TRL 4–5** | Сложность генерации кода под неоднородные ядра |
...
| **Interconnect** | NVLink 4 / NVSwitch | **[UCIe Interconnect](../lib-1/UCIe%20Interconnect.md)** / Open-RoCEv2 | **TRL 3–5** | Высокие задержки при масштабировании на $> 1000$ узлов |

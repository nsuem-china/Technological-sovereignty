...
| :--- | :--- | :---: | :---: | :--- | :--- |
| **[openEuler](../lib-1/openEuler.md)** | Базовая Серверная / Cloud ОС | **TRL 5** | **TRL 8** | Конфликты LSM, барьеры памяти e2k | Глубокий форк, LSM-stacking под КСЗ, AOT для eBPF |
| **[OpenHarmony](../lib-1/OpenHarmony.md)** | Мобильная / Edge / IoT ОС | **TRL 4** | **TRL 7** | Графический стек GPU, HDF, HUKS | Замена HUKS на ГОСТ, интеграция OP-TEE, RISC-V MCU |
| **[openGauss](../lib-1/openGauss.md)** | Enterprise OLTP СУБД | **TRL 5** | **TRL 8** | NUMA-зависимость Kunpeng, uStore lock-free | Адаптация MOT под Эльбрус-16С, ГОСТ-TLS репликация |
| **[OceanBase](../lib-1/OceanBase.md)** | Распределённая NewSQL СУБД | **TRL 3** | **TRL 6** | Закрытый Enterprise Paxos engine | Форк CE-версии, создание открытого модуля консенсуса |
...
* [openEuler: Архитектура, сборка и методы портирования](../lib-1/openEuler.md)
* [OpenHarmony: Стек HDF, ArkCompiler и замена HUKS](../lib-1/OpenHarmony.md)
* [openGauss: Движки uStore, MOT и оптимизация NUMA](../lib-1/openGauss.md)
* [OceanBase: Paxos Консенсус и LSM-Tree Архитектура](../lib-1/OceanBase.md)
* [Архитектура Эльбрус VLIW: Память, Компиляция LCC и eBPF](../lib-1/%D0%AD%D0%BB%D1%8C%D0%B1%D1%80%D1%83%D1%81%20e2k.md)
* [RISC-V в РФ: Перспективы экосистемы YADRO и Syntacore](../lib-1/RISC-V.md)
* [Linux Security Modules: LSM Stacking и разрешение коллизий](../lib-1/LSM.md)
* [Требования ФСТЭК по Уровням Доверия (УД 1-4)](../lib-1/%D0%A4%D0%A1%D0%A2%D0%AD%D0%9A%20%D0%A3%D0%94.md)
* [Mulan PSL v2: Юридический анализ и патентный декуплинг](../lib-1/Mulan%20PSL%20v2.md)
...
2. **Тестовые фермы (Hardware Matrix):**
   * Физические стенды под управлением контроллеров удаленного управления (IPMI/BMC), укомплектованные платами на базе [16С](../lib-1/16%D0%A1.md), [С](../lib-1/%D0%A1.md), [Syntacore](../lib-1/Syntacore.md) RISC-V FPGA/SoC.

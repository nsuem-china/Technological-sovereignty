...
> [!abstract] Обзор направления
> Настоящий анализ посвящен критическим аспектам достижения [[Технологический суверенитет|технологического суверенитета]] РФ в сфере [[Микроэлектроника|микроэлектроники]] на этапе перехода от опытно-конструкторских разработок к серийному производству (**TRL 7–9**). В фокусе внимания — физико-химические и инженерные барьеры адаптации китайского литографического оборудования зрелых техпроцессов (90–28 нм), развертывание мощностей [[Advanced Packaging|передового корпусирования (Advanced Packaging)]], а также создание устойчивых каналов поставок и [[Верификация ЭКБ|верификации электронной компонентной базы (ЭКБ)]] в условиях санкционного давления.
...
Основным игроком в КНР, способным поставлять литографические сканеры, является компания **[[SMEE]] (Shanghai Micro Electronics Equipment)**. Переход от лабораторных установок (TRL 4–6) к промышленной эксплуатации (TRL 7–9) в РФ требует детального понимания физических ограничений поставляемых систем.
...
> [!warning] Риски интеллектуальной собственности (IP) и "Черного ящика"
...
Поскольку уменьшение физического размера транзистора (More Moore) в РФ ограничено литографическим барьером, критическую важность приобретает концепция **More than Moore** — создание [[Система-в-корпусе|систем-в-корпусе (SiP)]], 2.5D и 3D-интеграция.
...
| **Текущий TRL в РФ** | **TRL 9** ([[GS Group]], [[Микрон]]) | **TRL 7** (Опытные образцы) | **TRL 4–5** (Лабораторные макеты) | **TRL 3** (НИР в академических институтах) |

### 2.2. Технологические барьеры освоения 2.5D/3D (TRL 7–9)

1.  **Формирование [[TSV|TSV (Through-Silicon Vias)]]**:
...
2.  **Изготовление [[Кремниевый интерпозер|кремниевых интерпозеров (Silicon Interposers)]]**:
...
> [!warning] Зависимость от ABF-субстратов
> Монополистом на рынке диэлектрических пленок для подложек высокой плотности является японская Ajinomoto (**[[ABF-субстрат|ABF-пленка]]**). Без нее невозможно создать подложки для процессоров уровня «Эльбрус» или «Байкал». Попытки заменить ABF на китайские аналоги (например, от *Shengyi Technology*) требуют полного перепроектирования топологии плат из-за других диэлектрических характеристик (диэлектрическая проницаемость $\varepsilon_r$, тангенс угла потерь $\tan\delta$).
...
В условиях поставок через неофициальные каналы доля брака и контрафакта (перемаркировка, восстановленные компоненты) может достигать 15–20%. Для обеспечения надежности класса Space/Military/Industrial применяется многоступенчатый протокол [[Верификация ЭКБ|верификации]]:

#### А. [[Неразрушающий контроль|Неразрушающий контроль (Non-Destructive Testing - NDT)]]
...
#### Б. [[Разрушающий контроль|Разрушающий контроль (Destructive Physical Analysis - DPA)]]
...
*   **[[FIB|FIB (Focused Ion Beam - Сфокусированный ионный пучок)]]**: Применяется для послойного анализа структуры кристалла при подозрении на наличие аппаратных закладок (Hardware Trojans) или для реверс-инжиниринга. Позволяет осуществлять локальное травление и осаждение металлов (Pt, W) для модификации схемы (circuit edit) на уровне TRL 7.

#### В. Функциональное тестирование (Electrical Testing)
*   **Параметрический контроль**: Измерение токов потребления в различных режимах, статических характеристик входов/выходов на автоматизированных измерительных системах (**[[ATE|ATE — Automatic Test Equipment]]**, например, отечественные системы серии «Формула»).
...
> [!question] Кейс 1: Проблема деламинации при 3D-корпусировании
...
> [!question] Кейс 2: Выявление скрытого контрафакта в партии ПЛИС

...
Развитие технологий дальнего космоса, ядерной энергетики и многоспутниковых группировок Китая — это вершина пирамиды инициативы **[Made_in_China_2025](../lib-1/Made_in_China_2025.md)** и последующих 14-го и 15-го пятилетних планов. Переход от копирования советских/российских и западных технологий к абсолютному технологическому суверенитету в космосе опирается на импортозамещение критических компонентов (радиационно-стойкая ЭКБ, сверхвысокотемпературные сплавы), вертикальную интеграцию цепочек поставок и асимметричное международное партнерство.
{% endhint %}

---

## 1. Международная научная лунная станция ([ILRS](../lib-1/ILRS.md))

Проект [ILRS](../lib-1/ILRS.md) (совместная инициатива CNSA и Роскосмоса) позиционируется как прямой конкурент американской программе Artemis. Однако технический и экономический паритет внутри этого альянса глубоко асимметричен.
...
Исторически Китай импортировал технологии жидкостных ракетных двигателей (ЖРД), включая технологии РД-120 и РД-170/180, а также систем жизнеобеспечения (СЖО). В рамках [ILRS](../lib-1/ILRS.md) ключевые риски для РФ и выгоды для КНР распределяются следующим образом:
...
### 1.2. Технический аудит ключевых подсистем [ILRS](../lib-1/ILRS.md) (TRL 1-6)

| Субсистема [ILRS](../lib-1/ILRS.md) :--- **Сверхтяжелая РН ([Long_March_9](../lib-1/Long_March_9.md))** | Текущий TRL (КНР) :---: **TRL 3-4** | Ключевые технические барьеры :--- Переход от керосинового ЖРД YF-130 к метановому YF-215 тягой 200 тс. Сварка трением с перемешиванием (FSW) крупногабаритных обечаек из Al-Li сплавов (диаметр 10 м). | Оценка IP-рисков для партнеров :--- **Высокий.** Попытки заимствования технологий трибологических пар, турбонасосных агрегатов (ТНА) и систем наддува баков у РФ. |  |
| --- | --- | --- | --- | --- |
| **Автоматические лунные станции ([Chang’e-6/7/8](../lib-1/**%D0%AF%D0%B4%D0%B5%D1%80%D0%BD%D1%8B%D0%B9%20%D0%B8%D1%81%D1%82%D0%BE%D1%87%D0%BD%D0%B8%D0%BA%20%D1%8D%D0%BD%D0%B5%D1%80%D0%B3%D0%B8%D0%B8%20%D0%B4%D0%BB%D1%8F%20%D0%BB%D1%83%D0%BD%D0%BD%D0%BE%D0%B9%20%D0%B1%D0%B0%D0%B7%D1%8B%201-100%20%D0%BA%D0%92%D1%82**.md))** **TRL 3-4** | **TRL 6** Создание высокотемпературного литиевого или газоохлаждаемого реактора. Деградация термоэлектрических преобразователей на основе SiGe/BiTe. Отвод тепла в вакууме. | Точная посадка в затененные кратеры (прецизионная навигация LiDAR + ИИ-распознавание рельефа ALHAT). Криогенный забор реголита с сохранением летучих веществ ($H_2O$ лед). **Средний.** Активный интерес к российским наработкам по космической ядерной энергетике (проект [**Низкий.** Китай здесь является технологическим лидером (успешный возврат грунта с обратной стороны Луны в миссии [[Chang_e_6](../lib-1/Untitled%20Note.md)). «Зевс»]]). |
...
| ### 2.1. Сравнительный анализ концепций ЯЭУ: РФ ([«Зевс»](../lib-1/Untitled%20Note.md)) vs. КНР (CAS MW-class) |
| --- | --- |
...
| #### 1. Российский проект ТЭМ [«Зевс»](../lib-1/Untitled%20Note.md) (TRL 4-5) |
| --- | --- |
...
{% hint style="warning" %}
**Критические технологические ограничения**
...
| 3. **Радиационно-стойкие бортовые вычислители ([Rad-Hard OBC](../lib-1/Untitled%20Note.md)):** |
| --- | --- |
...
| Риск :--- **IP-утечки из РФ в КНР** (в рамках [ILRS](../lib-1/ILRS.md)) **Санкционная блокировка EDA-софта** для КНР **Орбитальный коллапс (синдром Кесслера)** **Дефицит Ксенона/Криптона** для ЭРД | Вероятность :---: **Высокая** **Высокая** **Средняя** **Средняя** | Влияние :---: **Высокое** **Среднее** **Критическое** **Среднее** | Стратегия смягчения (Mitigation) :--- Жесткое разделение интерфейсов (Black Box approach). Передача готовых агрегатов (например, СЖО или ЯЭУ) без раскрытия конструкторской и технологической документации. Форсированные инвестиции в национальные САПР (Empyrean). Использование открытой архитектуры RISC-V для космических процессоров вместо ARM/SPARC. Обязательное оснащение каждого спутника LEO-группировок резервными двигателями увода с орбиты (криогенный газ или ЭРД) с TRL 6. Внедрение автономного уклонения на базе ИИ. Переход на альтернативные рабочие тела (Аргон, Йод). Разработка йодных ЭРД (TRL 4), требующих подогрева тракта подачи для исключения сублимации йода. |
| --- | --- | --- | --- |
...
#### Дальний космос и [ILRS](../lib-1/ILRS.md)
...
* Разработка новых сверхлегких композитов и технологий сварки FSW для [Long_March_9](../lib-1/Long_March_9.md) находит применение в гражданской авиации (C919/C929) и ракетостроении средней дальности.
...
{% hint style="info" %}
**Кейс 2: Преодоление пускового барьера (The Launch Bottleneck)**
...
1. **Технологический суверенитет КНР:** В рамках инициативы [Made_in_China_2025](../lib-1/Made_in_China_2025.md) КНР практически ликвидировала отставание по TRL в области спутникостроения и автоматических межпланетных станций (достигнут TRL 6).

...
### 2.1. Сравнительный анализ концепций ЯЭУ: РФ (**«Зевс»**) vs. КНР (CAS MW-class)
...
#### 1. Российский проект ТЭМ **«Зевс»** (TRL 4-5)
...
3. **Радиационно-стойкие бортовые вычислители (**Rad-Hard OBC**):**
...
1. Согласиться. Финансирование позволит завершить НИОКР по проекту **«Зевс»**, а модели без физических образцов бесполезны.

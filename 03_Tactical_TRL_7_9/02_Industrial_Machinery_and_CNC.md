...
| :--- | :--- | :--- | :--- |
| **Архитектура ядра** | Проприетарная (NCU на базе Intel/ARM + PLC Simatic S7-1500F) | Двухъядерная (Промышленный ПК на Linux + RTOS на сопроцессоре) | Открытая архитектура (ПК-совместимая плата + RTOS + [EtherCAT](../lib-1/EtherCAT.md)) |
| **Основная шина приводов** | [DRIVE-CLiQ](../lib-1/DRIVE-CLiQ.md) (проприетарная, 100 Мбит/с) | NCUC (проприетарная, 100 Мбит/с) / [EtherCAT](../lib-1/EtherCAT.md) | [EtherCAT](../lib-1/EtherCAT.md) (открытая, 100 Мбит/с) |
| **Кол-во каналов / осей** | До 10 каналов / до 31 оси | До 10 каналов / до 32 осей (5-осевая синхронная) | До 8 каналов / до 64 осей |
| **Интерполяция (микротакт)** | 0.5 мс (опционально 0.125 мс) | 1.0 мс (в последних ревизиях 0.25 мс) | 1.0 мс (на базе [EtherCAT](../lib-1/EtherCAT.md)) |
| **Интегрированная безопасность** | Safety Integrated (SIL 3 / PL e) | Базовая (STO на аппаратном уровне приводов) | Базовая (STO / SS1 через [EtherCAT](../lib-1/EtherCAT.md) FSoE) |
